;Quantome OS a 16-bit Operating System by DankDev and Mr.Golem
...
start:              ; start label from where our code starts
    ...
    start_os_intro db 'Welcome to Quantome OS!',0
    press_key db '>> Press any key to continue<<',0

    login_username db 'Username : ',0
    login_password db 'Password : ',0
    
    display_text db '! Welcome to Quantome OS !', 0

    os_info db 10, 'Version 0.1 (16 Bit)',13,0

    

    window_text db 10,'Graphics in OS......', 0
    hello_world_text db 10,10, '  Welcome To The Quantome!',0
